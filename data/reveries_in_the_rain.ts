...
export const reveriesInTheRain: { [key: string]: FloorData } = {
  ...
  "410m": {
    ...
    floor_type: "무광층",
    wholeEffect: [
      "상성 공격 시 피해 계수 20% 증가. 상성이 아닌 공격을 받을 때 최종 피해 면역 10% 증가 15턴을 넘길 시 몬스터가 광폭화 상태에 진입",
    ],
    enemyEffect: ["단일 공격으로 받는 피해는 자신의 최대 HP의 10%를 초과하지 않음."],
    teamEffect: [],
    enemies: [
      {
        id: "enemy_410m_1",
  ...
  "420m": {
    ...
    floor_type: "무광층",
    wholeEffect: [
      "상성 공격 시 피해 계수 50% 증가. 상성이 아닌 공격을 받을 때 최종 피해 면역 25% 증가 15턴을 넘길 시 몬스터가 광폭화 상태에 진입",
    ],
    enemyEffect: ["전투 진입 및 3턴 시작 시마다 행동횟수+1"],
    teamEffect: [],
    enemies: [
      {
        id: "enemy_420m_1",
  ...
  "430m": {
    ...
    enemyEffect: ["턴 시작시 자신이 [예의] 5스택 획득"],
    teamEffect: [],
    enemies: [
      {
        id: "enemy_430m_1",
    ...
    strategy: {
      overview: "",
      details: [
        "HP가 3줄인 것 말고는 특별한 기믹은 없음.",
        "스트레스 기믹이 있긴한데, 신경쓸 정도는 아니고, 최대한 강한 덱으로 밀면됨",
        "평범한 천체 추공덱으로도 충분히 밀림",
      ],
    },
    recommendedTeams: [],
  },
  "440m": {
    ...
    strategy: {
      overview: "",
      details: [
        "힐을 받을 수록 위축 스택이 쌓이면서, 피해감면이 줄어드니 장기전으로 하기는 까다로움",
        "에즈라는 쉴드량이 엄청 많은 대신 HP가 매우 적음",
        "그리고 쫄몹을 잡으면 에즈라의 HP를 1%씩 깎음",
        "연소 접대 기믹이 있고, 신빛은 쓰지않는 것을 추천 (기믹)",
        "조바벨 반격덱이나, 연소나 광역기 덱으로 하는 것을 추천함.",
        "사실 제일 좋은 것은 그냥 노티카급 체급은 그냥 트럭으로 밀어버릴 수 있기에 귀찮다면, 체급 좋은 덱도 추천됨",
      ],
    },
    recommendedTeams: [],
  },
  "450m-1": {
    ...
    enemyEffect: [],
    teamEffect: [
      "턴 시작 시 주문 상자에 불운 주문 3장 추가. 턴 종료 시 주문 구역에 존재하는 불운 주문 1장당 모든 아군 캐릭터에게 불운 주문 1회 시전. 최대 4회 발동",
      "1턴간 2회 행동 후 자신의 모든 [불운] 해제",
      "3턴 시작 시마다 아군 캐릭터의 [불운] 스택 2배",
    ],
    enemies: [
      {
        id: "enemy_450m_1_1",
    ...
    strategy: {
      ...
      details: [
        "보스는 페이즈가 3개가 있음",
        "매턴 불운을 추가하는데, 여유있을때마다 써주는 것을 추천함. 나중에 쌓이면 답없음.",
        "보스보다는 페이즈마다 나오는 쫄몹들이 강함. 2,3페이지 쫄몹은 나오자마자 술식을 쓰니 주의",
        "크게 강요되는 덱은 없고, 어느정도 체급만 있으면 무난하게 클리어 가능. 신혈덱이 제일 무난함",
        "3페이즈의 스파토데아는 궁을 매턴 난사하니, 유지력을 높이거나 빨리 잡거나 봉인을 걸거나 해야함.",
      ],
    },
    recommendedTeams: [],
  },
  "450m-2": {
    ...
    enemyEffect: ["1단계 주문에 공격 받을 시 받는 피해 30% 감소"],
    teamEffect: [
      "턴 시작 시 50% 확률로 아군의 모든 주문이 [예비 주문]으로 변경",
      "턴 시작 시 모든 아군이 [작열] 1스택 획득",
    ],
    enemies: [
      {
        id: "enemy_450m_2_1",
    ...
    strategy: {
      overview: "",
      details: [
        "1단계 주문은 30% 딜량이 낮아지니 정석 조합은, 승급덱임.",
        "매턴 잡몹을 소환하는데, 크게 신경은 안써도 되고 정리만 매턴 해주면 됨.",
        "보스에게 사용하는 카드의 스킬 레벨만큼 '열화 천둥' 스택이 쌓이는데 이걸 매턴 9~14로 유지해야함",
        "그렇지 않으면 보스에게 버프를 주거나, 엄청난 딜이 들어옴",
        "산귀를 사용하면, 산귀 스킬은 3성 주문 판정이니 도움이 됨.",
        "매턴 '작열'이라는 스택이 아군에게 부여가 되는데, 턴 종료시 최대 HP 10%의 피해를 받는데, 보스를 때리면 사라지니 잘 관리해줘야함",
        "승급, 히사베스, 계시 등의 주문레벨 관리가 쉬운덱으로 하는 것을 추천",
      ],
    },
    recommendedTeams: [],
  },
  "450m-3": {
    ...
    enemyEffect: [
      "받는 광역 최종 피해 25% 증가",
      "턴 종료 시 랜덤으로 적군 캐릭터 1명이 1턴간 [사기충전] 상태 획득. [사기충전] 상태인 캐릭터는 이번 턴 시작시 1턴간 [속박] 상태에 진입",
    ],
    teamEffect: [
      "최종 술식이 아닌 공격/치료/버프/음송/디버프/카우너 주문 직접 사용 후 적군이 야수/나무/천체/암석/영혼/지능 영감으로 변함",
    ],
    enemies: [
      {
        id: "enemy_450m_3_1",
    ...
    strategy: {
      overview: "",
      details: [
        "보스가 받는 광역딜이 25% 증가하고, 총 4페이즈까지 있음.",
        "스킬카드를 사용하면 영감이 변하는 기믹을 가지고 있기에, 극딜을 넣기 전에 본인에게 유리한 영감으로 바꾸도록 하는게 좋음",
        "페이즈마다 체력바에 선이 생기는데, 턴 종료시 그 선 아래로 체력이 내려가면 체력을 회복함",
        "회복할때마다 피해감면이 줄어들기때문에, 스택만 잘쌓으면서 한턴에 딜을 모두 넣는 플레이를 해야함.",
        "기본적이 딜량이 있어야 넘어갈 수 있는 덱이라, 전력 등의 강한덱을 쓰는 것 추천",
      ],
    },
    recommendedTeams: [],
  },
  "450m-4": {
    ...
    enemyEffect: [
      "턴 시작시 열정 +1",
      "일반 주문 공격을 받을 시 받는 피해 50% 감소. 최종 술식 곡격을 받을 시 받는 피해 50% 증가",
    ],
    teamEffect: ["턴 시작 시 모든 아군이 [산만] 2스택 획득"],
    enemies: [
      {
        id: "enemy_450m_4_1",
        name: "에너지 분석가",
    ...
    strategy: {
      overview: "",
      details: [
        "일반주문 공격을 받으면 받는 피해 50% 감소 + 술식 공격을 받을때는 받는 피해 50% 증가",
        "스트레스 기믹도 있긴한데, 100이상이면 딜이 더 들어가고 그 아래면, 딜이 덜 들어가거나 보스 딜이 쎄짐",
        "스킬 카드를 사용할때마다 그에 맞는 색깔의 에너리를 울리히가 얻음",
        "울리히는 매턴 가장 많은 색의 에너지에 따라 행동하는게 달라짐.",
        "에너지 구슬 갯수가 동일하면 맨 아래 구슬의 기술을 사용함.",
        "울리히의 술식은 어떻게든 막는게 좋기에, 콘블룸의 봉인때문에 기용률이 높다.",
        "보라, 빨강 구슬이 많을때 사용하는 스킬은 매우 아프니 조심해야함",
        "그렇기에 음송, 카운터, 응변이 있는 캐릭터를 적어도 1명이상 데려가는 것을 추천함.",
        "참고로 해당보스는 500m에도 같은 기믹으로 또 나오니 기믹을 귀찮다고 넘기지 말자.",
      ],
    },
    recommendedTeams: [],
  },
  "460m": {
    ...
    enemyEffect: [
      "전투 시작 시 [엄호 강화] 3스택 획득, 턴 시작시 [엄호 강화]를 보유하지 않은 경우 자신에게 [노출] 부여. [노출]의 지속 시간 종료 시 자신에게 [엄호 강화] 3스택 부여",
    ],
    teamEffect: ["치료율 -50%"],
    enemies: [
      {
    ...
    strategy: {
      overview: "",
      details: [
        "초반에는 정찰병을 먼저 잡고, 보스를 잡는 순서가 좋다. 보스가 소환하는 쫄몹들은 무시해도 된다.",
        "보스에게 맞으면, 마비 -> 기절이 걸리니 정화가 있는 캐릭터가 있으면 더 좋다.",
        "극딜 넣기 전에 엄호 스택을 빼주는게 좋고, 크게 어렵지 않는 스테이지",
      ],
    },
    recommendedTeams: [],
  },
  "470m": {
    ...
    enemyEffect: ["퇴장 시 모든 적군 열정 -3, 2턴간 [심란] 상태 부여"],
    teamEffect: [],
    enemies: [
      {
        id: "enemy_470m_1",
    ...
    strategy: {
      overview: "",
      details: [
        "적군이 퇴장하면, 모든 아군 열정 -3이되고, 2턴동안 열정을 얻지 못한다.",
        "적이 둘인데, 번갈아가면서 때리는게 좋음 (딜이 1씩 들어감)",
        "이상주의자가 술식을 쓰면, 기절이 걸릴 수 있으니, 이상주의자를 먼저 잡는 것을 추천함.",
        "공격받을때 적의 열정이 5면 바로 술식을 쓰니 주의해야함.",
        "공략만 알면 쉬운 스테이지",
      ],
    },
    recommendedTeams: [],
  ...
  "480m": {
    ...
    enemyEffect: ["2턴 시작 시마다 모든 아군의 [속성 감소][제어] 상태 정화"],
    teamEffect: [],
    enemies: [
      {
        id: "enemy_480m_1",
    ...
    strategy: {
      overview: "",
      details: [
        "적들은 상태이상이 걸릴 수록, 받는 피해가 증가하는데, 2턴마다 상태이상을 모두 정화한다.",
        "상태이상을 넣는 조합이 좋고, 상태이상이 없으면 적들이 날뛰면서 술식을 난사하니 조심해야함",
        "사실 그래도 신혈급 체급이 되면 그냥 체급으로 뚫는게 가능함.",
      ],
    },
    recommendedTeams: [],
  },
  "490m": {
    ...
    enemyEffect: [],
    teamEffect: [
      "턴 종료 시 삼연귀소는 마지막으로 직접 주문을 사용한 캐릭터에게 [포커스]부여, 1턴간 지속. [포커스]를 보유한 목표에게 주기적으로 매우 높은 피해의 공격 시전. [정지 프레임]을 활용해 회피 가능",
    ],
    enemies: [
      {
        id: "enemy_490m_1",
    ...
    strategy: {
      overview: "",
      details: [
        "1페이즈는 이전 480과 같은 기믹이니 중요하지 않고, 2페이즈가 꽤나 어려움",
        "턴 마지막에 스킬을 쓴 캐릭터가 '포커스' 상태가 되고, 이 상태에서 보스의 술식을 맞으면 정지 상태가 되며 아무것도 못하게 되고, ㅂ보스 분신이 생성됨.",
        "모든 캐릭터가 정지 상태가 되면 자동 패배함.",
        "NG 장면 스택이 있는데, 이게 다 차면 매우 강한 공격을 하는데, 대부분은 즉사급 딜이 들어옴.",
        "쉽게 말해, 가장 마지막에 스킬 쓰는 캐릭터가 딜러가 아니면 되고, 분신만 잘잡으면 됨.",
      ],
    },
    recommendedTeams: [],
  },
  "500m-1": {
    ...
    wholeEffect: [
      "상성 피해 계수 50% 증가. 비상성 공격을 받을 시 최종 피해 면역 25% 증가. 15턴을 넘길 시 몬스터가 광폭 상태 진입",
      "공격 받은 후 [연소] 2스택 획득, 단일 공격일 경우 추가로 [위축] 1스택 획득. 공격 받은 후 [연소]를 30스택 보유한 경우 폭발이 일어나 1턴간 [기절]획득",
    ],
    enemyEffect: [],
    teamEffect: [
      "이번 턴에 아군이 버프 유형 일반 주문 3장 직접 사용 후 모든 아군에게 1턴간 [기절] 부여",
      "공격 유형 일반 주문 직접 사용 후 [느릿느릿] 1스택 획득",
    ],
    enemies: [
      {
        id: "enemy_500m_1_1",
    ...
    strategy: {
      overview: "",
      details: [
        "맞으면 연소가 쌓이고, 연소 30스택이 쌓이면 기절이걸림. 아군, 적군 동일",
        "매턴 버스 3장 직접 사용하면, 적군 기절 부여함. 천체 접대로 천체 추공 접대 스테이지",
        "당연히 여기서도 파투투나, 키페리나 같은 정화 캐릭터가 있으면 매우 효율적임",
        "울루 2개를 모두 피 0으로 만들면, 보스가 각성하면서 그때부터 딜이 들어간다. (그전에는 거의 안들어감)",
        "순서만 보면, 울루 2개 잡기 -> 보스 일점사하기",
        "보호막 상태인 적군을 때리면, 보스가 반격을 하니 참고",
        "스파토 술식은 거의 매턴 난사하고, 제어도 면역이 많아서 몸으로 때우는 수밖에 없음.",
        "체급있는 천체딜러들은 대부분 사용가능. ex 윈드송",
      ],
    },
    recommendedTeams: [],
  },
  "500m-2": {
    ...
    teamEffect: [
      "모든 아군의 받는 피해 50% 영구 증가. 최종 술식 시전 후 모든 아군이 받는 피해 25% 감소, 2턴간 지속",
      "턴 시작 시 모든 아군이 [산만] 2스택 획득",
    ],
    enemies: [
      {
        id: "enemy_500m_2_1",
    ...
    strategy: {
      overview: "",
      details: [
        "450m-4 대비 강화된 버전이며, 원생 영감 공격시 30% 피해감소",
        "450-3보다 더 어려워지고, 기믹도 추가되서, 힘들겠다 싶으면 신혈팟으로 하면 밀린다.",
        "기본적인 공략은 450-3과 거의 동일하며, 여전히 술식 접대가 있음.",
        "스트레스 기믹이 여기도 있는데 0~30 구간에 극딜하는게 좋음.",
        "보스 피가 40% 이하가 되면, 분신을 소환하고, 분신은 매턴 랜덤 구슬 1개슬 생성함",
        "참고로 분신은 죽요도 소환하기 때문에 잡지 않고, 보스 일점사를 해야함",
      ],
    },
    recommendedTeams: [],
  },
  "500m-3": {
    ...
    enemyEffect: [
      "턴 시작 시 [총력] 2스택 획득. 턴 종료 시 [달콤한 술] 상태 및 [연소] 상태가 30 이상일 경우 보유한 [달콤한 술] 1스택당 최대 HP 3%의 고정 피해를 받음",
    ],
    teamEffect: [
      "턴 시작 시 [달콤한 술] 1스택 획득, 4턴간 지속",
      "직접 주문을 사용해 공격 후 자신의 [달콤한 술]을 적군 주 목표의 [달콤한 술]에 부여. 턴 종료시 [달콤한 술] 상태 및 [연소] 상태가 30이상일 경우 보유한 [달콤한 술] 1스택당 최대 HP 10%의 고정 피해를 받음",
    ],
    enemies: [
      {
        id: "enemy_500m_3_1",
    ...
    strategy: {
      overview: "",
      details: [
        "여기도 450-2처럼, 승급 접대 스테이지",
        "2개의 스테이지로 나눠져있고, 1스테이지 곡랑은 크게 어렵지 않음.",
        "쫄몹들만 잘처리하면서 곡랑 일점사하면 쉽게 클리어",
        "2스테이지에서 보스가 둘인데, 둘다 같이 죽여야 클리어가 됨. 한명이 죽으면 안죽고 매턴 회복함",
        "왼쪽보스는 면역이 전혀없고, 오른쪽 보스는 공격받은 주문 단계당 스택이 쌓이고, 스택은 12~14나 24이상을 매턴 맞춰야함",
        "왼쪽은 제어를 걸 수 있으면 좋고, 아니면 최대한 승급덱 체급으로 밀어버리면 클리어 가능",
      ],
    },
    recommendedTeams: [],
  },
  "500m-4": {
    ...
    enemyEffect: ["턴 시작 시 [총력] 2스택 획득"],
    teamEffect: [
      "공격 유형 일반 주문 직접 사용 후 [느릿느릿] 1스택 획득",
      "음송 유형 일반 주문 직접 사용 후 [총력] 2스택 획득",
    ],
    enemies: [
      {
        id: "enemy_500m_4_1",
    ...
    strategy: {
      overview: "",
      details: [
        "공격 주문을 쓰면 피해 보너스가 줄어들고, 음송 주문을 쓰면 주는 피해가 증가함. 음송 딜러 접대",
        "4페이즈까지 있고, 1~3페이즈까지 나온 적군이 4페이즈에는 다같이 나옴",
        "1~3페이즈는 크게 어렵지 않고, 4페이즈가 관건.",
        "최종 보스 빼고 나머지 3명의 양월을 빈사상태로 만들어야함. 3턴뒤에 부활하니 참고",
        "3명의 양월을 빈사로 만들면, 보스가 최종술식을 쓰면서 나머지 적들은 퇴장함.",
        "그 이후는 그냥 깡스펙, 체급으로 밀어야한다. 생각보다 클리어가 힘든 스테이지",
        "음송을 자주쓰는 울리히가 있으면 조금 편하고, 나머지는 형상이 없으면 힘듦",
      ],
    },
    recommendedTeams: [],
  },
