...
export const characterGuideList: CharacterGuide[] = [
  ...
  },
  {
    ...
    portrait_info: {
      ...
      source: "米嘉·风焰",
      note: "가장 효율이 높은 형상은 1형상. 초창기 캐릭터인만큼 형상 효율이 적음",
    },
    youtube_links: [],
  ...
  },
  {
    ...
    portrait_info: {
      ...
      source: "米嘉·风焰",
      note: "가장 효율이 높은 형상은 DPM기준 1형상, HPM기준 3형상. 형상 효율은 무난함",
    },
  ...
  },
  {
    ...
    portrait_info: {
      ...
      source: "米嘉·风焰",
      note: "최대한 자주 1스킬을 2-3단계로 사용하는 사이클일 때, 가장 효율이 높은 형상은 2형상, 3인전 기준은 1형상. 대체적으로 형상 효율이 낮고, 광상을 받았지만 메타덱에 쓰이진 않음",
    },
  ...
  },
  {
    ...
    portrait_info: {
      ...
      source: "米嘉·风焰",
      note: "형상 효율이 대체적으로 낮으며, 대부분 신혈덱 서포터로 들어가기때문에, 형상은 비추천",
    },
    youtube_links: [],
  ...
  },
  {
    ...
    portrait_info: {
      ...
      source: "米嘉·风焰",
      note: "가장 효율이 높은 형상은 1형상, 풀형상 기준 성능 효율 증가량은 높음, 하지만 애정 또는 핵과금같은 상황이 아닌 이상은 비추천. 5형상 효율이 0인 이유는 2스킬 보호막 부여량 증가가 효과이기 때문,",
    },
  ...
  },
  {
    ...
    youtube_links: ["https://www.youtube.com/watch?v=2bLjy-puUCw"],
  ...
  },
  {
    ...
    portrait_info: {
      ...
      source: "icehood",
      note: "1형상이 사이클을 1턴정도 줄여줘서 꽤나 체감이되고, 2형상은 의미가 없을정도. 형상효율은 무난한데, 고점이 엄청 올라가는 캐릭터가 아니라서 애정이 아니라면 형상은 비추",
    },
  ...
  },
  {
    ...
    portrait_info: {
      ...
      source: "icehood",
      note: "형상효율을 정확하게 계산하는 분석가가 없을 정도로, 명함으로 사용해도 무리가 없는 캐릭터임. (5형상이 명함대비 효율 : 15% 미만)",
    },
  ...
  },
  {
    ...
    portrait_info: {
      ...
      rows: [
        {
          name: "1형상",
          efficiencies: ["15.5%", "19.2%", "22%"],
        },
        {
          name: "2형상",
          efficiencies: ["14.1%", "7.2%", "25%"],
        },
        {
          name: "3형상",
          efficiencies: ["10.1%", "13.4%", "8%"],
        },
        {
          name: "4형상",
          efficiencies: ["15.4%", "17.5%", "14%"],
        },
        {
          name: "5형상",
          efficiencies: ["12.9%", "7.5%", "18%"],
        },
      ],
  ...
  },
  {
    ...
    youtube_links: ["https://www.youtube.com/watch?v=NMelmXolcPM"],
  ...
  },
  {
    ...
    youtube_links: ["https://www.youtube.com/watch?v=PsFdY40tvZs"],
  ...
  },
  {
    ...
    youtube_links: ["https://www.youtube.com/watch?v=sbJKIEK_LZI"],
