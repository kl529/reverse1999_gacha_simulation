...
export const recommendTeams: RecommendTeam[] = [
  {
    ...
    description: [
      ...
      "초반에는 1딜+1서폿+1힐로도 충분[[히]] 스토리 및 컨텐츠를 즐길 수 있음.",
  ...
  },
  {
    ...
    description: [
      ...
      "승급 상태에서의 안정적인 딜 [[사]]이클과 높은 단일 딜링이 특징",
    ],
    concepts: ["나무", "주문강화", "단일"],
    characters: [
  ...
  },
  {
    ...
    concepts: ["즉흥주문", "나무", "계시"],
    characters: [
      { id: 60, isMain: true, role: "딜러", psycubeId: 92 },
      {
        id: 7,
        psycubeId: 88,
        euphoria: true,
      ...
      { id: 14, role: "서폿", psycubeId: 4, euphoria: true },
      {
        id: 46,
        psycubeId: 71,
        role: "탱커",
  ...
  },
  {
    ...
    concepts: ["전력", "술진", "연소"],
    characters: [
      { id: 55, isMain: true, euphoria: true, role: "딜러", psycubeId: 42 },
  ...
  },
  {
    name: "베릴 여광덱",
    description: [
      "[[베]]릴을 메인으로 하는 여광(여광) 조합. 현딜러 3대장(브룸, 베릴, 노사전) 중 하나",
      "상대에게 부여된 연소와 빛무리에 비례한 여광 스택을 쌓아 딜을 하는 구조",
    ...
    characters: [
      ...
      { id: 24, isMain: true, euphoria: true, role: "서폿", psycubeId: 87 },
      {
        ...
        psycubeId: 88,
        role: "서폿",
        alternatives: [{ id: 31, role: "서폿", euphoria: true }],
      },
      {
        id: 58,
        psycubeId: 89,
  ...
  },
  {
    name: "코르부스 전력덱",
    description: [
      "코르부[[스]]와, 카론 전력 키워드를 메인으로 하는 조합",
      "[요동치는 전기장]이라는 [[술]]진을 강화시키며, 전기장 3레벨에 폭딜을 넣는 구조",
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 29, isMain: true, euphoria: true, role: "딜러", psycubeId: 51 },
  ...
  },
  {
    ...
    concepts: ["중독", "고정딜"],
    characters: [
      { id: 37, isMain: true, euphoria: true, role: "딜러", psycubeId: 39 },
      { id: 33, isMain: true, role: "딜러", psycubeId: 6 },
      {
        id: 4,
        euphoria: true,
        role: "힐러",
        alternatives: [{ id: 30, role: "탱커" }],
        psycubeId: 23,
      },
      {
        id: 15,
  ...
  },
  {
    ...
    concepts: ["신혈", "자해"],
    characters: [
      { id: 9, euphoria: true, isMain: true, role: "딜러", psycubeId: 81 },
      {
        id: 52,
        psycubeId: 76,
        role: "서폿",
  ...
  },
  {
    ...
    concepts: ["추가 공격", "암살"],
    characters: [
      { id: 47, isMain: true, role: "딜러", psycubeId: 42 },
  ...
  },
  {
    name: "술식 에지오덱",
    description: [
      "에지오의 술[[식]] 관련 무기(콘도티에로 전쟁 망치 + 채널드 친퀘데아)를 사용하여 활용하는 덱",
  ...
  },
  {
    ...
    concepts: ["중독", "고정딜"],
    characters: [
      { id: 47, isMain: true, role: "딜러", psycubeId: 18 },
  ...
  },
  {
    ...
    concepts: ["현실피해", "야수"],
    characters: [
      { id: 6, euphoria: true, isMain: true, role: "딜러", psycubeId: 58 },
    ...
    characters: [
      {
        id: 36,
        role: "서폿",
        alternatives: [{ id: 8, euphoria: true, role: "힐러" }],
        psycubeId: 61,
      },
  ...
  },
  {
    ...
    description: [
      ...
      "6 대신 머큐리아를 넣어도 좋고, 파투투로 생존이 어려우면 키페리나/[[마]]샤로 대체 가능",
    ],
    concepts: ["추공"],
    characters: [
  ...
  },
  {
    name: "안조 추공덱",
    description: [
      "안조를 메인으로, 키페리나/플러터 페이[[지]]/파투투와 함께하는 추공 조합",
    ...
    concepts: ["추공", "안조 계약"],
    characters: [
      { id: 35, isMain: true, role: "딜러", psycubeId: 40 },
      {
        id: 46,
        psycubeId: 71,
        role: "서폿",
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 13, isMain: true, euphoria: true, role: "서폿", psycubeId: 29 },
      {
        id: 38,
        role: "서폿",
        alternatives: [{ id: 18, role: "서폿" }],
        psycubeId: 88,
      },
      {
        id: 40,
        role: "힐러",
        alternatives: [{ id: 36, role: "힐러" }],
        psycubeId: 15,
      },
    ],
  },
  ...
  },
  {
    ...
    characters: [
      ...
      { id: 1, euphoria: true, isMain: true, role: "서폿", psycubeId: 70 },
      {
        id: 4,
        euphoria: true,
        role: "힐러",
  ...
  },
  {
    ...
    concepts: ["자해", "암석", "비주류"],
    characters: [
      { id: 28, isMain: true, role: "딜러", psycubeId: 43 },
      {
        id: 13,
        psycubeId: 29,
        euphoria: true,
  ...
  },
  {
    ...
    description: [
      ...
      "J와 뉴바벨의 보호[[막]]으로 높은 안정성으로 반격딜 위주로 딜을 함",
